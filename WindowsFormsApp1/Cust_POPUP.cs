...
{
    public partial class Cust_POPUP : Form
    {
        public Cust_POPUP()
        {
            InitializeComponent();
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                try
                {
                    string cuscode  = row.Cells[0].Value.ToString();
                    string custname = row.Cells[1].Value.ToString();
                    BM_ItemMaster_MM.Custname = custname;
                    BM_ItemMaster_MM.Custcode = cuscode;
                    ITEM_POPUP_REQUEST.Custname = custname;
                    ITEM_POPUP_REQUEST.Custcode = cuscode;
                    PW_Purchase_Warehousing.Custname = custname;
                    PW_Purchase_Warehousing.Custcode = cuscode;
                    PW_ORDER_POPUP.Custname = custname;
                    PW_ORDER_POPUP.Custcode = cuscode;
